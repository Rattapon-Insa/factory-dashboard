...
st_autorefresh(interval= 5 * 1000, key="queryrefresh")
...
st.write('This is dashboard for robot in Factory A')
...
if st.sidebar.button('Robot A, call back'):
    update_script = 'UPDATE robot SET callback = true WHERE id = 1;'
    cur.execute(update_script)

if st.sidebar.button('Robot B, call back'):
